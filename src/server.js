...
app.put('/projects/:projectId/tasks/:taskId', authMiddleware, taskController.updateTask);
app.delete('/projects/:projectId/tasks/:taskId', authMiddleware, taskController.deleteTask);
